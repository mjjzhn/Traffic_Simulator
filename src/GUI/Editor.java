    ...
    public void newMap(){
        ...
        MouseAdapter mouseAdapter = new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (roads.size() == 0){
                    if (e.getY() < 10){
                        roads.add(new Road(Integer.toString(roads.size()),1,50,new int[]{x1,0},Road.Orientation.Vertical));
                    }else if(e.getX() < 10){
                        roads.add(new Road(Integer.toString(roads.size()),1,50,new int[]{0,y1}, Road.Orientation.HORIZONTAL));
                    }
                }else {
                    ...
                    switch (orientationSelection) {
                        case 0:
                            roads.add(new Road(Integer.toString(roads.size()), 1, 50, new int[]{x1,
                                    y1}, Road.Orientation.HORIZONTAL));
                            break;
                        case 1:
                            roads.add(new Road(Integer.toString(roads.size()), 1, 50, new int[]{x1,
                                    y1}, Road.Orientation.Vertical));
                    }
